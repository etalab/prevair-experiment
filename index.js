...
const spatialIndex = createSpatialIndex(join(__dirname, 'data', 'PREVAIR.prevision.20180223.MAXJ0.PM25.public.nc'))
...
module.exports = async (req, res) => {
  ...
  const result = await spatialIndex.search({lon, lat})
